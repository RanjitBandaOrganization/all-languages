...
namespace CourseLibrary.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Transient is a lifetime advised by the ASP.NET Core team for lightweight,
            //stateless services.
            //So let's register it as such. With that,
            //we can now inject our PropertyMappingService where we need it and get the mapping dictionary.
