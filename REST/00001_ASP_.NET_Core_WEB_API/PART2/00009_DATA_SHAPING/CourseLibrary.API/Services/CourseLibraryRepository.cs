...
namespace CourseLibrary.API.Services
{
    public class CourseLibraryRepository : ICourseLibraryRepository
    {
            ...
            IPropertyMappingService propertyMappingService)
        {
            ...
            //We'll need access to the mappingDictionary.
            //So let's inject the MappingService in the repository.
            ...
            )
        {
            ...
            {
                //So the first thing we need to do is get that mappingDictionary.
                // get property mapping dictionary
                var authorPropertyMappingDictionary =
                    _propertyMappingService.GetPropertyMapping<Models.AuthorDto, Author>();

                returnedAuthors = returnedAuthors.ApplySort(authorsResourceParameters.OrderBy,
                    authorPropertyMappingDictionary);
            }

            return PagedList<Author>.Create(returnedAuthors,
        ...
        public void DeleteCourse(Guid authorId, Course course)
        {
            _authorData.Authors.First(x => x.Id == authorId).Courses.Remove(course);
        }
        ...
        public void DeleteAuthor(Author author)
        {
            ...
            _authorData.Authors.Remove(author);
        }
