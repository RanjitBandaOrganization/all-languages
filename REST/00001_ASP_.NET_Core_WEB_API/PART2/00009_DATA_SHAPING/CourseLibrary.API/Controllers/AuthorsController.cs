...
namespace CourseLibrary.API.Controllers
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        //AS WE HAVE TO RETURN THE DYNAMIC EXPANDO OBJECT IT'S BETTER TO SWITCH BACK TO IACTIONRESULT
        ...
        {
            //
            // Check whether the passed in field in the OrderBy class are valid
            //
            ...
            //
            // Check whether the passed in field in the fields parameter are valid
            //
            ...
            //    });
            //}
            var authors = _mapper.Map<IEnumerable<AuthorDto>>(authorsFromRepo).ShapeData(authorsResourceParameters.Fields);
